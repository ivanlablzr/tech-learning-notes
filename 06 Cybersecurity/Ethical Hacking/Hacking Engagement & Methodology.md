...
Linux: https://github.com/rebootuser/LinEnum.git , https://github.com/sleventyeleven/linuxprivchecker
Windows: https://github.com/GhostPack/Seatbelt , https://github.com/411Hall/JAWS
Server: https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite

### 3.2 Vulnerability assessment — map and probe

Map live hosts, ports, services, and versions (`nmap`, masscan) , then probe each service deeply to find misconfigurations or vulnerabilities: web content discovery (`ffuf`, gobuster), SMB/LDAP/SNMP enumeration, and automated vuln scanning (Nessus, nuclei). The output is a prioritized list of things worth attacking.
...
Unix binaries: https://gtfobins.org/
	...
	- Projects/
		- Acme Company/
			...
			- IPT/ (Internal Penetration Test)
				- evidence/ (assessment types, finding/vulnerability title, description, impact, remediation advice, and references)
					- credentials/
					- data/
					- screenshots/
				- logs/
