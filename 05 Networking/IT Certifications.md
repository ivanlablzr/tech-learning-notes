...
- **Cloud:** 
	...
	- Azure (AZ-104 Administrator → Solutions Architect → SC-200)
	- https://kodekloud.com/100-days-of-mlops?utm_term=&utm_content=
	- https://www.zerotocloud.co/learning-paths
- **DevOps:** 
...
- **Data / AI:** 
	...
	- IBM Data Science
	- Azure AI Engineer
	- AI auditing (ISACA AAIA — emerging, high-demand)
	- https://kodekloud.com/100-days-of-mlops?utm_term=&utm_content=
	- https://www.zerotocloud.co/learning-paths
- **Governance / management:** CISSP (governance), CISM (management), CISA (audit), ISO 27001.


> **My Choice**: GRC Mastery -> HTB CPTS/OSCP -> DevOps (boot.dev) -> Dante/Zephyr HTB -> HTB CDSA/CySA+/Security+ -> Cloud (AWS/Azure) -> AI certs/courses (AWS AI, Azure AI, Anthropic AI, ISACA AAIA, AI security) -> GHIC -> CRTO -> OSEP -> SANS Purple Team Operations Certificate -> GFCA and GFCA -> CISSP
...
> This is the **full reference** of certs by track. For *your* ordered path — which certs, in what sequence, toward the consultant goal — see the **[[Cyber Roadmap|Master Roadmap]]** "path at a glance" table and work it daily from the **[[Roadmap Kanban]]**.

Related: [[Cyber Roadmap|Master Roadmap]] · [[Roadmap Kanban]] · [[Switching & Routing]] · [[06 Cybersecurity|Cybersecurity]] · [[09 Cloud]] · [[05 Networking|domain overview]]
